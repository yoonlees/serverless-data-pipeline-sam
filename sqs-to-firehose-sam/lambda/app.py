...
def lambda_handler(event, context):
    ...
    sqs_to_kinesis_mapping = {
        "arn:aws:sqs:us-east-2:430229884637:sqs-to-firehose-StreamQueue-VBWFFR44OUZC":
        "sam-lrs-data-pipeline-DeliveryStream-8M7sKQ88lQhF"
    }
